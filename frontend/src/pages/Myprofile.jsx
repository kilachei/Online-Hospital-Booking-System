...
import { assets } from '../assets/assets'; // Corrected path, adjust as needed

const Myprofile = () => {
  const [userData, setUserData] = useState({
    name: "Kenneth Kipkirui",
    image: assets.profile_pic,
    email: "kenkilachei@gmail.com",
    phone: '254727318468',
    address: { // Corrected spelling
      line1: "57th Cross, Richmond",
      line2: "Circle, Church Road, Sotik"
    },
    gender: "Male",
    dob: "2002-11-18"
  });
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          <p className='foont-medium'>Gender:</p>
          {
            isEdit
