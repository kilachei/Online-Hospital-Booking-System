...
const Banner = () => {
  ...
  return (
    <div className='flex bg-blue-400 rounded-lg  px-6 sm:px-10 md:px-14 my-20 md:mx-10'>
      {/*....left side...*/}
      <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
        <div className='text-xl sm:text-2xl md:text-3xl lg:text-5xlv font-semibold text-white'>
